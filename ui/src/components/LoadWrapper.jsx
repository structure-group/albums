export default function LoadWrapper({ loaders, children }) {
    const isFetching = loaders.some((loader) => loader.isFetching || loader === true);
    // const isFetching = true;
    return (
        <>
            {isFetching && (
                <div className="absolute bottom-2 right-2 z-50 w-4 h-4">
                    <svg width="16" height="16" viewBox={"0 0 16 16"}>
                        <path
                            fill="rgba(33,157,255,1)"
                            fillRule="evenodd"
                            clipRule="evenodd"
                        ...
                        ></path>
                        <path
                            className="fill-white dark:fill-indigo-black"
